...
class CustomFields(Base):
    ...
    custom_field_conn = relationship(
        "CustomFieldTypes", back_populates="custom_field_type_conn"
    )
...
class CustomFieldTypes(Base):
    ...
    custom_field_type_conn = relationship(
        "CustomFields", back_populates="custom_field_conn"
    )
